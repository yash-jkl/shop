...
export class Init1697018777576 implements MigrationInterface {
    name = 'Init1697018777576'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_756f53ab9466eb52a52619ee01" ON "cart" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_371eb56ecc4104c2644711fa85" ON "cart" ("productId") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_168ba3f85d177b138464fb8065" ON "product" ("is_available") `);
        ...
        await queryRunner.query(`CREATE TABLE "payment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "checkout_id" uuid NOT NULL, "user_id" uuid NOT NULL, "product_id" uuid NOT NULL, "product_title" character varying NOT NULL, "product_price" integer NOT NULL, "admin_id" uuid NOT NULL, "quantity" integer NOT NULL DEFAULT '1', "status" character varying NOT NULL DEFAULT 'pending', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_125c5afaa7216a2bf2b2127fdf4" UNIQUE ("checkout_id", "product_id"), CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_2b26f37c948355fc254229ae4cf" FOREIGN KEY ("adminId") REFERENCES "admin"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_168ba3f85d177b138464fb8065"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_371eb56ecc4104c2644711fa85"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_756f53ab9466eb52a52619ee01"`);
